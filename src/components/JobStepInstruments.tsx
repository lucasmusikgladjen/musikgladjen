      ...
      {showOtherField && (
        <div className="mt-4">
          ...
          <input
            ...
            className="w-full px-4 py-3 rounded-xl border border-gray-200 shadow-[0_1px_2px_rgba(0,0,0,0.04)] outline-none text-base bg-bg-white transition-colors placeholder:text-gray-400"
            maxLength={100}
          />
        </div>
      )}
